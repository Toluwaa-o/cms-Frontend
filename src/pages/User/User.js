  ...
  return (
    <div className='profile'>
        ...
        <div>
          ...
          <input value={data.number} onChange={dataUpdater} type='tel' name='number' id='number' placeholder='Phone Number' />
        </div>

        <div>
          <label htmlFor='address'>Address</label>
          <input value={data.address} onChange={dataUpdater} type='text' name='address' id='address' placeholder='Address' />
        </div>
